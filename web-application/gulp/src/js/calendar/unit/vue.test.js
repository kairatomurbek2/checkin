...
describe('Calendar unit test', function () {
    ...
    it("should test updateLiveQueve", function () {
        var scheduleDay = {
            time: {
                start: '09:00',
                end: '16:00'
        ...
        assert.deepEqual(scheduleDay, whatShouldBe);
        assert.deepEqual(scheduleDay2, whatShouldBe2);
        assert.deepEqual(scheduleDay3, whatShouldBe3);
        assert.deepEqual(scheduleDay4, whatShouldBe4);
    })
})