...
from api.views import CompanyListView, SpecialistListView, ScheduleSettingRetrieveView, ReservationView
...
urlpatterns = [
    ...
    url(r'^reservation/(?P<specialist__slug>[-_\w]+)/$', ReservationView.as_view(), name='reservation_master')
]
